...
- **v6.6.0**：#9 JetBrains 插件（IntelliJ/GoLand，本机可做）+ boot 模块 HTTP server（KylixBoot 应用无 Go 环境真正可用）+ stdlib 补全（UrlEncode / httpclient JSON / jwt claims / Variant div/mod / cache TTL）。
