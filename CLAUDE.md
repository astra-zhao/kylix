...
- **v6.8.0**：boot server 补强（POST body 读取 / `req.JSON` 绑定 / `BootRegisterJwtAuth` 真校验）+ stdlib 补全（encoding Base64URL / httpclient JSON 嵌套）+ JetBrains 插件完善（错误高亮彩色方案、`.klx` 文件图标、Run 配置）。
