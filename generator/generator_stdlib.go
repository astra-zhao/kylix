...
var stdlibModuleFuncs = map[string]map[string]bool{
	...
	"httpclient": strToSet(
		...
		"HttpPut", "HttpDelete", "HttpPostJSON",
	...
	"websocket": strToSet(
		...
		"WsDialConnect", "WsDialFinish", // v0.6.5 two-phase handshake
	),
...
var stdlibErrorFuncReturnTypes = map[string]string{
	...
	"WsRecv":          "string",
	"WsDialConnect":   "*stdlib.TWsConn", // v0.6.5 two-phase handshake
	"WsDialFinish":    "bool",
	"ListDir":         "[]string",
	"ListFiles":       "[]string",
	"ReadLines":       "[]string",
	...
	"TcpAccept":       "*stdlib.TTcpConn", // v0.6.5: WsAccept takes a TcpAccept result
