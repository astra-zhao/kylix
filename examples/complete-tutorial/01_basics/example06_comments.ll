; Kylix LLVM IR — module: Comments
source_filename = "Comments.klx"
...
entry:
  %t0 = getelementptr inbounds [37 x i8], ptr @.str.0, i64 0, i64 0, !dbg !5
  %t1 = call i32 @puts(ptr noundef %t0), !dbg !6
  %t2 = getelementptr inbounds [19 x i8], ptr @.str.1, i64 0, i64 0, !dbg !7
  %t3 = call i32 @puts(ptr noundef %t2), !dbg !8
  %t4 = getelementptr inbounds [17 x i8], ptr @.str.2, i64 0, i64 0, !dbg !9
  %t5 = call i32 @puts(ptr noundef %t4), !dbg !10
  ret i32 0
}

; ===== String constants =====
@.str.0 = private unnamed_addr constant [37 x i8] c"Comments are ignored by the compiler\00", align 1
@.str.1 = private unnamed_addr constant [19 x i8] c"This line executes\00", align 1
@.str.2 = private unnamed_addr constant [17 x i8] c"Program finished\00", align 1
...
!3 = !DIFile(filename: "example06_comments.klx", directory: "/Users/astra/Documents/ai/learn/kylix/examples/complete-tutorial/01_basics")
!4 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 1, type: !12, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !15)
!5 = !DILocation(line: 9, column: 11, scope: !4)
!6 = !DILocation(line: 9, column: 10, scope: !4)
!7 = !DILocation(line: 12, column: 11, scope: !4)
!8 = !DILocation(line: 12, column: 10, scope: !4)
!9 = !DILocation(line: 17, column: 11, scope: !4)
!10 = !DILocation(line: 17, column: 10, scope: !4)
!11 = !{null}
